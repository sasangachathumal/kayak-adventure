      ...
      background={
        <>
          ...
          <div className="absolute inset-0 z-0">
            <Image
              src="/cta-bg.png"
              alt="Calm Sri Lankan lagoon waters at Rathgama"
              fill
              priority
              sizes="100vw"
    ...
    >
      ...
      <div className="relative z-10 max-w-2xl pt-36 lg:pt-44">
        ...
        <Reveal variant="fade-left" delay={100} duration={600}>
          ...
          >
            <defs>
              <linearGradient id="contact-page-hero-brand-fade" x1="0" y1="0" x2="72" y2="0" gradientUnits="userSpaceOnUse">
            ...
            <path
              ...
              fill="url(#contact-page-hero-brand-fade)"
            />
          </svg>
        </Reveal>
        ...
        <Reveal variant="clip-up" delay={150} duration={900}>
          <h1 className="font-serif text-[40px] sm:text-5xl md:text-[64px] text-white font-medium leading-[1.1] tracking-wide mb-6">
            Let&apos;s plan your{" "}
            <span className="italic font-medium">adventure.</span>
          </h1>
        </Reveal>
        ...
        <Reveal variant="blur-in" delay={350} duration={800}>
          <p className="font-sans text-[15px] sm:text-[16px] md:text-[17px] text-white/80 leading-[1.75] font-medium tracking-wide max-w-md">
            <span className="block md:hidden">
              Reach out via WhatsApp, call, or email — we&apos;re always happy to help.
            </span>
            <span className="hidden md:inline">
              Have a question or want to book a tour? Reach out via WhatsApp,
              give us a call, or drop us an email, we&apos;ll get back to you promptly.
            </span>
          </p>
        </Reveal>
      </div>
