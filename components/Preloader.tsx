...
export default function Preloader() {
  ...
  useEffect(() => {
    ...
    // Phase: idle (logo + wordmark fully visible)
    const idleTimer = setTimeout(() => setPhase("idle"), PHASE.WORD_ENTER + 500);

    // Phase: exit (begin curtain slide)
    ...
    // Phase: done (unmount)
    const destroyTimer = setTimeout(() => setPhase("done"), PHASE.DESTROY);
